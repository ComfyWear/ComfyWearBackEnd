...
urlpatterns = [
    *router.urls,
    ...
    path('integrate/comfort-level-distribution/', IntegrateViewSet.as_view({'get': 'comfort_level_distribution'}), name='comfort-level-distribution'),
    ...
    path('integrate/comfort-level-details/', IntegrateViewSet.as_view({'get': 'comfort_level_details'}), name='comfort-level-details'),
    ...
    path('integrate/label-counts/', IntegrateViewSet.as_view({'get': 'label_counts'}), name='label-counts'),
    path('integrate/label-counts/<str:label>/', IntegrateViewSet.as_view({'get': 'label_counts'}), name='label-count-detail'),
]
